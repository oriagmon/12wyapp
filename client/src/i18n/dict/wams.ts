...
export const wams: AreaDict = {
  en: {
    'wams.celebration.bothHit': 'A shared win!',
    'wams.celebration.greatWeek': 'A great week!',
    'wams.celebration.forwardTogether': 'Moving forward together',
    'wams.celebration.tie': 'A close tie!',
    'wams.celebration.done': 'Meeting complete',
    'wams.celebration.close': 'Close',
    'wams.celebration.bothMessage': 'You both hit 85% or more this week — real teamwork!',
    'wams.celebration.duoStreak': '🔥 Duo streak: ',
    'wams.celebration.winner': '{name} led on execution this week — {winner}% against {other}%.',
    'wams.celebration.winnerAbove': 'Nice work hitting the target!',
    'wams.celebration.winnerBelow': 'Every step done counts. Pick the next one together.',
    'wams.celebration.tieMessage': 'A tie — exactly the same score this week. Pick the next step together!',
    'wams.celebration.doneMessage': 'The weekly meeting is complete.',
  ...
  he: {
    'wams.celebration.bothHit': 'הצלחה משותפת!',
    'wams.celebration.greatWeek': 'שבוע מצוין!',
    'wams.celebration.forwardTogether': 'ממשיכים קדימה יחד',
    'wams.celebration.tie': 'תיקו צמוד!',
    'wams.celebration.done': 'הפגישה הושלמה',
    'wams.celebration.close': 'סגירה',
    'wams.celebration.bothMessage': 'שניכם הגעתם ל־85% ומעלה השבוע — ממש עבודת צוות!',
    'wams.celebration.duoStreak': '🔥 רצף Duo: ',
    'wams.celebration.winner': '{name} הוביל/ה בביצוע השבוע — {winner}% מול {other}%.',
    'wams.celebration.winnerAbove': 'כל הכבוד על העמידה ביעד!',
    'wams.celebration.winnerBelow': 'כל צעד שבוצע נחשב. בוחרים יחד את הצעד הבא.',
    'wams.celebration.tieMessage': 'תיקו — אותו ציון בדיוק השבוע. בוחרים יחד את הצעד הבא!',
    'wams.celebration.doneMessage': 'הפגישה השבועית הושלמה בהצלחה.',
