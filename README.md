# שנת 12 השבועות — 12-Week Year Dashboard

Hebrew RTL web app for running 12-week execution cycles: up to 3 goals, weekly
...
reminders, and full multi-cycle history.
...
`https://w12.israelcentral.cloudapp.azure.com/`. Session cookies are
...
APP_PUBLIC_URL=https://w12.israelcentral.cloudapp.azure.com/
```
